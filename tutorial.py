...
if os.environ.get('COLAB_NOTEBOOK_TEST', False):
  ...
  def display_video(filename, frames, framerate=30):
...
display_video("vid1.mp4", frames, framerate)
...
display_video("vid2.mp4",frames, framerate)
...
creatures = [make_creature(num_legs=num_legs) for num_legs in range(1,2)]

print("CREATURE")
print(creatures[0].to_xml_string())
...
height = .15
grid = 5 * BODY_RADIUS
xpos, ypos, zpos = np.meshgrid([0], [0], [height])
...
display_video("vid3.mp4", video, framerate)
exit(0)
...
display_video("vid4.mp4", frames, framerate=1./env.control_timestep())
...
display_video("vid5.mp4", all_frames, 30)